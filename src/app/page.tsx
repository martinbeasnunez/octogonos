        ...
        <div className="pb-8 pt-10 sm:pt-16">
          <div className="flex items-start justify-between gap-8">
            <div className="flex-1">
              ...
              <h1
                id="hero-title"
                className="animate-hero-reveal font-display text-3xl font-black uppercase leading-[0.95] tracking-tight text-voraz-black sm:text-5xl lg:text-6xl"
              >
                Los octógonos
                <br />
                de los candidatos
                <br />
                <span className="text-voraz-black">x VORAZ</span>
              </h1>

              {/* Subtitle — VORAZ marketing copy */}
              <div className="mt-5 max-w-lg space-y-3 text-sm leading-relaxed text-voraz-gray-600 animate-fade-in" style={{ animationDelay: "200ms" }}>
                <p>
                ...
                <p className="font-bold text-voraz-black">
